  ...
  <div id="pageDashboard">
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        ...
        <v-flex lg3 sm6 xs12>
          <mini-statistic icon="fa fa-facebook" title="100+" sub-title="Likes" color="red"> </mini-statistic>
        </v-flex>
        <v-flex lg3 sm6 xs12>
          <mini-statistic icon="fa fa-google" title="150+" sub-title="Connections" color="indigo"> </mini-statistic>
        </v-flex>
        <v-flex lg3 sm6 xs12>
